...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            ...
            <a href="merchants/create" class="btn btn-box-tool">
                <i class="fa fa-plus"></i> Add New</a>
            </div>
        </div>
        <div class="box-body">
            <table class="table table-striped table-hover datatable-dom-position" id="merchant-table" data-page-length="10" width="100%">
                <thead>
                    <tr>
                        <th class="">ID</th>
...
<script type="text/javascript">
    var url = '/admin/merchant';
    
    var oTable = $('#merchant-table').on('error.dt',function(e, settings, techNote, message){
